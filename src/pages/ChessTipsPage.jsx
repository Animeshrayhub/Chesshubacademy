...
export default function ChessTipsPage() {
  ...
  useEffect(() => {
    getSEOContentByCategory('strategy').then(setLessons);
    getBlogsByCategory('chess-improvement').then(setArticles);
  }, []);
  ...
  return (
    <div className="seo-page">
      ...
      <div className="seo-hero">
        <h1>Chess Tips & Improvement Strategies</h1>
        <p>Practical advice and proven methods to level up your chess game. Whether you're a beginner or intermediate player, these tips will help you improve faster.</p>
      </div>
      ...
      {lessons.length === 0 && articles.length === 0 && (
        <div className="seo-lessons" style={{ textAlign: 'center' }}>
          <p style={{ color: '#aaa' }}>Chess tips & guides coming soon!</p>
        </div>
      )}

      <div className="seo-cta">
        <h2>Want personalized chess coaching?</h2>
        <p>Our expert coaches create custom training plans tailored to your skill level and goals.</p>
