...
export default function Testimonials() {
    ...
    const testimonials = [
        ...
        {
            name: 'Radhika Panuganthy',
            location: 'Hyderabad, India',
            role: 'Parent of Suveer, Age 12',
            rating: 5,
